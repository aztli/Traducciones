#! /bin/bash
#: titulo		: ToolTranslatetoPo
#: Fecha		: 2011-03-07
#: Autor		: l10n-kde4 pero modificado por lelouch <lelouchy@gmail.com>
#: Version		: 1.0
#: Descripcion	: Regresa el texto usado en el programa y hace la plantilla .pot
#: Opciones		: Ninguna
...
export EXTRACTRC EXTRACTATTR EXTRACTQML MSGCAT PREPARETIPS REPACKPOT EXTRACT_GRANTLEE_TEMPLATE_STRINGS
if [ "x$IGNORE" = "x" ]; then
	IGNORE="/tests/"
else
	IGNORE="$IGNORE
